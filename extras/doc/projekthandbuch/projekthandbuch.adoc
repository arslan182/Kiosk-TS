...
[plantuml,kiosk-router,svg]
----
include::kiosk-router.plantuml[]
----
...
[plantuml,kiosk-write-router,svg]
----
include::kiosk-write-router.plantuml[]
----
...
."KioskService" von der Geschäftslogik
[plantuml,KioskService,svg]
----
include::KioskService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."KioskWriteService" von der Geschäftslogik
[plantuml,KioskWriteService,svg]
----
include::KioskWriteService.plantuml[]
----
